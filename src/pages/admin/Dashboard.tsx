...
import { TimeActivity } from '../../components/ui/TimeActivity';
import { MonthlyHoursTracker } from '../../components/time-tracking/MonthlyHoursTracker';
import type { Employee, LeaveRequest, ResignationRequest } from '../../types';

type Tab = 'dashboard' | 'employees' | 'leave-requests' | 'time-tracking' | 'resignation-requests';
            ...
            {activeTab === 'dashboard' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    <TimeActivity employees={employees} />
                  </div>
                </div>
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-bold text-[#105283]">Monthly Hours Overview</h2>
                    <input
                      type="month"
                      value={selectedMonth}
